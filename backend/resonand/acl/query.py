...
* **Refusals are graded** (``DEC-14``). Below :attr:`~resonand.core.levels.Level.READ` the answer
...
def require_audio(
    ...
    *,
    ...
    Below :attr:`~resonand.core.levels.Level.READ` this raises
    :class:`~resonand.core.errors.NotFoundError` whether the recording is missing, trashed or
    ...
    :class:`~resonand.core.errors.PermissionDeniedError`, because pretending a recording the user
