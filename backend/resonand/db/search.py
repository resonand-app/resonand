...
from resonand.db.models import Audio, Job, Segment, Transcript
...
def apply_filters(query: Any, filters: Filters) -> Any:
    ...
    """
    from resonand.db.models import AudioTag, Library, Tag  # noqa: PLC0415 -- narrow, avoids a cycle
...
def _state_predicate(state: TranscriptionState) -> ColumnElement[bool]:
    ...
    This has to answer exactly what :func:`resonand.api.presenters.transcription_state` answers,
