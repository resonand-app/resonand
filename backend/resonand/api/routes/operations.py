...
from resonand.api.presenters import job_summary
...
from resonand.core.errors import NotFoundError, ToolError
from resonand.db.engine import build_engine
from resonand.db.migrate import revisions
...
from resonand.transcription.last_check import CheckOutcome, LastCheck
...
def _provider_status(settings: Settings, checks: LastCheck) -> ProviderStatus:
    ...
    status = ProviderStatus(
        ...
        detail=(
            ...
            "RESONAND_TRANSCRIPTION_BASE_URL."
        ),
    )
