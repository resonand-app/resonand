...
from resonand.api.errors import install_error_handlers
from resonand.api.headers import SecurityHeaders
from resonand.api.limits import RequestSizeLimit
from resonand.api.logging import RequestCorrelationMiddleware, configure_logging
from resonand.api.namespace import API_PREFIX
from resonand.api.rate_limit import AttemptLimiter
from resonand.api.routes import (
    admin,
    audio,
    auth,
    events,
...
from resonand.api.spa import inline_script_hashes, install_spa
from resonand.core.changes import Changes
from resonand.core.config import Settings, get_settings
from resonand.db.engine import Database, build_engine
from resonand.db.migrate import migrate_at_startup
from resonand.jobs.handlers import Context
from resonand.jobs.worker import Worker
from resonand.transcription.last_check import LastCheck
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    if app.state.spa is None:
        ...
        def instance() -> dict[str, Any]:
            ...
            """
            return {"name": "resonand", "version": __version__, "status": "ok"}
...
async def _lifespan(app: FastAPI) -> AsyncIterator[None]:
    ...
    :func:`~resonand.db.migrate.migrate_at_startup`, because two containers coming up together
