...
from resonand.core.colours import Colour
from resonand.core.levels import DESCRIPTIONS, Level
...
from resonand.db.models import (
    Audio,
    Category,
    Job,
    Library,
...
def _state_of(has_transcript: bool, job_states: set[str]) -> TranscriptionState:
    ...
    The same question is answered in SQL by :func:`resonand.db.search.apply_filters`, and the two
    have to agree -- see :mod:`resonand.core.states`.
    """
    if has_transcript:
...
def transcription_states(
    ...
    Two whatever the page holds, following :func:`resonand.db.tags.tags_for_audios`. Asked one
