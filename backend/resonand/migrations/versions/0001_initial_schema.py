...
This file is the source of truth for the schema; ``resonand.db.models`` mirrors it and a test
...
and it is maintained by explicit writes from ``resonand.db.search_index`` alone. Its projection
...
under an audio nobody touched. ``JOB-9``'s ``resonand reindex`` rebuilds both.
...
SCHEMA: tuple[str, ...] = (
    ...
    # resonand.db.search_index -- see the note at the top of this file.
    """
