...
from resonand.transcription.capabilities import Capabilities, Support
...
def probe(
    ...
    *,
    ...
    A :class:`~resonand.core.errors.ProviderError` is the answer rather than an accident: the
