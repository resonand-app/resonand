...
there are two: :func:`sonarium.api.presenters.transcription_state` answers it for one recording
and :func:`sonarium.db.search.apply_filters` answers it in SQL for a whole query. If those two
