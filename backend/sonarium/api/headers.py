...
Sonarium serves its own interface, its own API and its own users' audio from one origin, and it
...
wholesale (see :func:`~sonarium.api.spa.inline_script_hashes`), so a policy stays a policy: no
