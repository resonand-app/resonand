...
expressed, if at all, as a ``SONARIUM_*`` variable they were expected to know the right value for.
...
**This belongs to a provider instance and never to** :class:`~sonarium.core.config.Settings`.
