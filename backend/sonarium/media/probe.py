...
question and it is :mod:`sonarium.media.recorded_at`'s (``ING-12``) -- without which every
...
from sonarium.core.errors import InvalidRequestError, ToolError
...
def parse_probe(payload: dict[str, Any], *, fallback_size: int = 0) -> Probe:
    ...
    if audio is None:
        raise InvalidRequestError(
            "This file has no audio track. Sonarium is an audio archive; a video with no sound "
